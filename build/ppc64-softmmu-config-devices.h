...
#define CONFIG_FDT_PPC 1

#define CONFIG_FW_CFG_PPC 1
...
#define CONFIG_SPAPR_RNG 1

#define CONFIG_SPAPR_VSCSI 1
...
#define CONFIG_XICS 1

#define CONFIG_XICS_SPAPR 1
...
#define CONFIG_XIVE 1

#define CONFIG_XIVE_SPAPR 1
