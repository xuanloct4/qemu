...
static inline void _nocheck__trace_guest_mem_before_trans(void * __cpu, uint16_t info)
{
    if (true && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
...
static inline void trace_guest_mem_before_trans(void * __cpu, uint16_t info)
{
...
static inline void _nocheck__trace_guest_mem_before_exec(void * __cpu, uint64_t vaddr, uint16_t info)
{
    if (true && qemu_loglevel_mask(LOG_TRACE)) {
        struct timeval _now;
        gettimeofday(&_now, NULL);
...
static inline void trace_guest_mem_before_exec(void * __cpu, uint64_t vaddr, uint16_t info)
{
