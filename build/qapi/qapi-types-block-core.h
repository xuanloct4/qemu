...
typedef enum DirtyBitmapStatus {
    ...
    DIRTY_BITMAP_STATUS_DISABLED,
    DIRTY_BITMAP_STATUS_FROZEN,
    DIRTY_BITMAP_STATUS_LOCKED,
    DIRTY_BITMAP_STATUS_INCONSISTENT,
    DIRTY_BITMAP_STATUS__MAX,
} DirtyBitmapStatus;
...
typedef struct BlockDirtyBitmapMergeSource BlockDirtyBitmapMergeSource;

typedef struct BlockDirtyBitmapMergeSourceList BlockDirtyBitmapMergeSourceList;
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(ImageInfoList, qapi_free_ImageInfoList)
...
struct BlockDirtyBitmapMergeSource {
    QType type;
    union { /* union tag is @type */
        char *local;
...
void qapi_free_BlockDirtyBitmapMergeSource(BlockDirtyBitmapMergeSource *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockDirtyBitmapMergeSource, qapi_free_BlockDirtyBitmapMergeSource)

struct BlockDirtyBitmapMergeSourceList {
    BlockDirtyBitmapMergeSourceList *next;
    BlockDirtyBitmapMergeSource *value;
};

void qapi_free_BlockDirtyBitmapMergeSourceList(BlockDirtyBitmapMergeSourceList *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockDirtyBitmapMergeSourceList, qapi_free_BlockDirtyBitmapMergeSourceList)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockdevOptionsSheepdog, qapi_free_BlockdevOptionsSheepdog)
...
struct BlockdevOptions {
    ...
    union { /* union tag is @driver */
        ...
        BlockdevOptionsGenericFormat copy_on_read;
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(SheepdogRedundancyFull, qapi_free_SheepdogRedundancyFull)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(SheepdogRedundancyErasureCoded, qapi_free_SheepdogRedundancyErasureCoded)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(SheepdogRedundancy, qapi_free_SheepdogRedundancy)
...
G_DEFINE_AUTOPTR_CLEANUP_FUNC(BlockdevCreateOptionsSheepdog, qapi_free_BlockdevCreateOptionsSheepdog)
