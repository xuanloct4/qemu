                 ...
                 ImageInfoList **obj, Error **errp)
{
    ...
    for (tail = *obj; tail;
        ...
        if (!visit_type_ImageInfo(v, NULL, &tail->value, errp)) {
            goto out_obj;
        }
    }
...
bool visit_type_ImageInfoSpecificVmdk_members(Visitor *v, ImageInfoSpecificVmdk *obj, Error **errp)
{
    ...
    if (!visit_type_ImageInfoList(v, "extents", &obj->extents, errp)) {
        return false;
    }
    return true;
}
...
bool visit_type_q_obj_ImageInfoSpecificQCow2_wrapper_members(Visitor *v, q_obj_ImageInfoSpecificQCow2_wrapper *obj, Error **errp)
{
...
bool visit_type_q_obj_ImageInfoSpecificVmdk_wrapper_members(Visitor *v, q_obj_ImageInfoSpecificVmdk_wrapper *obj, Error **errp)
{
...
bool visit_type_q_obj_QCryptoBlockInfoLUKS_wrapper_members(Visitor *v, q_obj_QCryptoBlockInfoLUKS_wrapper *obj, Error **errp)
{
...
bool visit_type_ImageInfoSpecific_members(Visitor *v, ImageInfoSpecific *obj, Error **errp)
{
    ...
    case IMAGE_INFO_SPECIFIC_KIND_QCOW2:
        return visit_type_q_obj_ImageInfoSpecificQCow2_wrapper_members(v, &obj->u.qcow2, errp);
    case IMAGE_INFO_SPECIFIC_KIND_VMDK:
        return visit_type_q_obj_ImageInfoSpecificVmdk_wrapper_members(v, &obj->u.vmdk, errp);
    case IMAGE_INFO_SPECIFIC_KIND_LUKS:
        return visit_type_q_obj_QCryptoBlockInfoLUKS_wrapper_members(v, &obj->u.luks, errp);
    default:
        abort();
    }
    return true;
...
bool visit_type_BlockDeviceInfo_members(Visitor *v, BlockDeviceInfo *obj, Error **errp)
{
    ...
    if (!visit_type_bool(v, "encryption_key_missing", &obj->encryption_key_missing, errp)) {
        return false;
    }
...
bool visit_type_DirtyBitmapStatus(Visitor *v, const char *name,
                 DirtyBitmapStatus *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &DirtyBitmapStatus_lookup, errp);
    *obj = value;
    return ok;
}
...
bool visit_type_BlockDirtyInfo_members(Visitor *v, BlockDirtyInfo *obj, Error **errp)
{
    ...
    if (!visit_type_DirtyBitmapStatus(v, "status", &obj->status, errp)) {
        return false;
    }
...
bool visit_type_q_obj_block_passwd_arg_members(Visitor *v, q_obj_block_passwd_arg *obj, Error **errp)
{
    if (visit_optional(v, "device", &obj->has_device)) {
        if (!visit_type_str(v, "device", &obj->device, errp)) {
            return false;
                 ...
                 BlockDirtyBitmapMergeSource **obj, Error **errp)
{
    ...
    default:
        ...
        /* Avoid passing invalid *obj to qapi_free_BlockDirtyBitmapMergeSource() */
        g_free(*obj);
        *obj = NULL;
    }
out_obj:
...
{
    bool ok = false;
    BlockDirtyBitmapMergeSourceList *tail;
    size_t size = sizeof(**obj);
    ...
    for (tail = *obj; tail;
         tail = (BlockDirtyBitmapMergeSourceList *)visit_next_list(v, (GenericList *)tail, size)) {
        if (!visit_type_BlockDirtyBitmapMergeSource(v, NULL, &tail->value, errp)) {
            goto out_obj;
        }
    }
...
out_obj:
    visit_end_list(v, (void **)obj);
    if (!ok && visit_is_input(v)) {
        qapi_free_BlockDirtyBitmapMergeSourceList(*obj);
        *obj = NULL;
    }
    return ok;
}
...
bool visit_type_BlockDirtyBitmapMerge_members(Visitor *v, BlockDirtyBitmapMerge *obj, Error **errp)
{
    ...
    if (!visit_type_BlockDirtyBitmapMergeSourceList(v, "bitmaps", &obj->bitmaps, errp)) {
        return false;
    }
    return true;
}
...
bool visit_type_BlockdevOptionsSheepdog_members(Visitor *v, BlockdevOptionsSheepdog *obj, Error **errp)
{
    if (!visit_type_SocketAddress(v, "server", &obj->server, errp)) {
        return false;
    }
    if (!visit_type_str(v, "vdi", &obj->vdi, errp)) {
        return false;
    }
    if (visit_optional(v, "snap-id", &obj->has_snap_id)) {
        if (!visit_type_uint32(v, "snap-id", &obj->snap_id, errp)) {
            return false;
        }
    }
...
bool visit_type_BlockdevOptionsSheepdog(Visitor *v, const char *name,
                 BlockdevOptionsSheepdog **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(BlockdevOptionsSheepdog), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_BlockdevOptionsSheepdog_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_BlockdevOptions_members(Visitor *v, BlockdevOptions *obj, Error **errp)
{
    ...
    case BLOCKDEV_DRIVER_COPY_ON_READ:
        return visit_type_BlockdevOptionsGenericFormat_members(v, &obj->u.copy_on_read, errp);
    case BLOCKDEV_DRIVER_DMG:
...
#endif /* defined(CONFIG_REPLICATION) */
    case BLOCKDEV_DRIVER_SHEEPDOG:
        return visit_type_BlockdevOptionsSheepdog_members(v, &obj->u.sheepdog, errp);
    case BLOCKDEV_DRIVER_SSH:
...
bool visit_type_SheepdogRedundancyType(Visitor *v, const char *name,
                 SheepdogRedundancyType *obj, Error **errp)
{
    int value = *obj;
    bool ok = visit_type_enum(v, name, &value, &SheepdogRedundancyType_lookup, errp);
    *obj = value;
    return ok;
}

bool visit_type_SheepdogRedundancyFull_members(Visitor *v, SheepdogRedundancyFull *obj, Error **errp)
{
    if (!visit_type_int(v, "copies", &obj->copies, errp)) {
        return false;
    }
    return true;
}

bool visit_type_SheepdogRedundancyFull(Visitor *v, const char *name,
                 SheepdogRedundancyFull **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(SheepdogRedundancyFull), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_SheepdogRedundancyFull_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_SheepdogRedundancyErasureCoded_members(Visitor *v, SheepdogRedundancyErasureCoded *obj, Error **errp)
{
    if (!visit_type_int(v, "data-strips", &obj->data_strips, errp)) {
        return false;
    }
    if (!visit_type_int(v, "parity-strips", &obj->parity_strips, errp)) {
        return false;
    }
    return true;
}

bool visit_type_SheepdogRedundancyErasureCoded(Visitor *v, const char *name,
                 SheepdogRedundancyErasureCoded **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(SheepdogRedundancyErasureCoded), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_SheepdogRedundancyErasureCoded_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_q_obj_SheepdogRedundancy_base_members(Visitor *v, q_obj_SheepdogRedundancy_base *obj, Error **errp)
{
    if (!visit_type_SheepdogRedundancyType(v, "type", &obj->type, errp)) {
        return false;
    }
    return true;
}

bool visit_type_SheepdogRedundancy_members(Visitor *v, SheepdogRedundancy *obj, Error **errp)
{
    if (!visit_type_q_obj_SheepdogRedundancy_base_members(v, (q_obj_SheepdogRedundancy_base *)obj, errp)) {
        return false;
    }
    switch (obj->type) {
    case SHEEPDOG_REDUNDANCY_TYPE_FULL:
        return visit_type_SheepdogRedundancyFull_members(v, &obj->u.full, errp);
    case SHEEPDOG_REDUNDANCY_TYPE_ERASURE_CODED:
        return visit_type_SheepdogRedundancyErasureCoded_members(v, &obj->u.erasure_coded, errp);
    default:
        abort();
    }
    return true;
...
bool visit_type_SheepdogRedundancy(Visitor *v, const char *name,
                 SheepdogRedundancy **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(SheepdogRedundancy), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_SheepdogRedundancy_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_BlockdevCreateOptionsSheepdog_members(Visitor *v, BlockdevCreateOptionsSheepdog *obj, Error **errp)
{
    if (!visit_type_BlockdevOptionsSheepdog(v, "location", &obj->location, errp)) {
        return false;
    }
    if (!visit_type_size(v, "size", &obj->size, errp)) {
        return false;
    ...
    if (visit_optional(v, "redundancy", &obj->has_redundancy)) {
        if (!visit_type_SheepdogRedundancy(v, "redundancy", &obj->redundancy, errp)) {
            return false;
        }
    }
    if (visit_optional(v, "object-size", &obj->has_object_size)) {
        if (!visit_type_size(v, "object-size", &obj->object_size, errp)) {
            return false;
        }
    }
    return true;
...
bool visit_type_BlockdevCreateOptionsSheepdog(Visitor *v, const char *name,
                 BlockdevCreateOptionsSheepdog **obj, Error **errp)
{
    bool ok = false;

    if (!visit_start_struct(v, name, (void **)obj, sizeof(BlockdevCreateOptionsSheepdog), errp)) {
        return false;
    }
    if (!*obj) {
        /* incomplete */
    ...
    if (!visit_type_BlockdevCreateOptionsSheepdog_members(v, *obj, errp)) {
        goto out_obj;
    }
    ok = visit_check_struct(v, errp);
out_obj:
...
bool visit_type_BlockdevCreateOptions_members(Visitor *v, BlockdevCreateOptions *obj, Error **errp)
{
    ...
    case BLOCKDEV_DRIVER_SHEEPDOG:
        return visit_type_BlockdevCreateOptionsSheepdog_members(v, &obj->u.sheepdog, errp);
    case BLOCKDEV_DRIVER_SSH:
