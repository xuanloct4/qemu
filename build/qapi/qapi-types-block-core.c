...
const QEnumLookup DirtyBitmapStatus_lookup = {
    .array = (const char *const[]) {
        ...
        [DIRTY_BITMAP_STATUS_INCONSISTENT] = "inconsistent",
    },
...
const QEnumLookup BlockPermission_lookup = {
    .array = (const char *const[]) {
        ...
        [BLOCK_PERMISSION_GRAPH_MOD] = "graph-mod",
    },
...
void qapi_free_BlockDirtyBitmapMergeSource(BlockDirtyBitmapMergeSource *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BlockDirtyBitmapMergeSource(v, NULL, &obj, NULL);
    visit_free(v);
}
...
void qapi_free_BlockDirtyBitmapMergeSourceList(BlockDirtyBitmapMergeSourceList *obj)
{
    ...
    v = qapi_dealloc_visitor_new();
    visit_type_BlockDirtyBitmapMergeSourceList(v, NULL, &obj, NULL);
    visit_free(v);
}
